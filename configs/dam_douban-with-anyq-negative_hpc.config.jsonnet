...
local model_name = "dam_douban-with-anyq-negative_use-bert-emb-%s_dropout-%s_LS%s-%s" % [use_bert_embeddings, std.toString(dropout)[:3], num_lr_step, std.toString(lr_gamma)[:3]];
