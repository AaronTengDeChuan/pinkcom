local dataset_dir = "data/dam/douban_with_anyq_negative";
...
local num_validation_examples = 47136;
local num_training_examples = 942088;
local num_log = 100;
...
local model_name = "smn_last_douban-with-anyq-negative_use-bert-emb-%s_dropout-%s_LS%s-%s" % [use_bert_embeddings, std.toString(dropout)[:3], num_lr_step, std.toString(lr_gamma)[:3]];
