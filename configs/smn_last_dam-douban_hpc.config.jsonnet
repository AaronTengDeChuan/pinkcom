...
local model_name = "smn_last_douban_use-bert-emb-%s_last-score-true_dropout-%s_LS%s-%s_%s"
    % [use_bert_embeddings, std.toString(dropout)[:3], num_lr_step, std.toString(lr_gamma)[:3], std.split(loss_fn, '.')[2]];
