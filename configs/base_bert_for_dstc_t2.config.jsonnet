...
local batch_size = 10;
local num_validation_examples = 50500;
local num_training_examples = 1100000;
...
local model_name = "bert_for_dstc";
    ...
    "metrics":
        {
            ...
            "validation": [
             #   {   "function": "metrics.metric.Recall_N_at_K", "params": {"N": 10, "AN": 2, "K": 1, "skip": false} },
                ...
                {   "function": "metrics.metric.MRR_in_N", "params": {"N": 101, "skip": false} },
                {   "function": "metrics.metric.Precision_N_at_K", "params": {"N": 101, "K": 1, "skip": false} },
                {   "function": "metrics.metric.Accurary", "params": {} }
            ],
            "evaluate": [
                {   "function": "metrics.metric.Recall_N_at_K", "params": {"N": 10, "AN": 2, "K": 1, "skip": false} },
