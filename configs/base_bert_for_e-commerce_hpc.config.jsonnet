...
local log_dir = "logs/bert";
local model_dir = "models/Bert";
...
local model_name = "chinese-bert_for_e_commerce-multi-turn-response-selection_valid%s-LS%s_%s"
    % [num_validation, num_lr_step, std.toString(lr_gamma)[:3]];
    ...
    "data_manager":
        {
            "data_load": {
                ...
                "params": {
                    ...
                    "phase": "training",
                    "training_files": ["train_small.txt", "dev.txt"],
//                    "training_files": ["train.txt", "dev.txt"],
