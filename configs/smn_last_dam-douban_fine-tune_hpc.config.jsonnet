...
local num_training_examples = 1000001;
local num_log = 100;
...
local model_name = "smn_last_douban_use-bert-emb-%s_last-score-true_dropout-%s_LS%s-%s_fine-tune"
    % [use_bert_embeddings, std.toString(dropout)[:3], num_lr_step, std.toString(lr_gamma)[:3]];
    ...
    "training":
        {
            ...
            "grad_clipping": 10,
            "fine_tune": "/users3/dcteng/work/pinkcom/models/SMN/smn_last_douban-with-anyq-negative_use-bert-emb-false_dropout-0_LS5-1/model.pkl",
