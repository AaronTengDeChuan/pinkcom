...
class BertModel(PreTrainedBertModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, output_all_encoded_layers=True, output_embeddings=False, only_embeddings=False):
        ...
        if output_embeddings and only_embeddings: return None, None, embedding_output
